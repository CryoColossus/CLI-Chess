// For Compiling-> g++ chess.cpp -o chess -static-libgcc -static-libstdc++ -lwinmm
#include <iostream>
#include <fstream>
#include <deque>
#include <queue>
	...
	for (int i = 0; i < 8; i++)
	{
		for (int k = 0; k < 3; k++)
		{
			for (int j = 0; j < 8; j++)
			{
				...
				{
					cout << "\u2588\u2588";
					if (board[i][j] == 'P' || board[i][j] == 'N' || board[i][j] == 'B' || board[i][j] == 'R' || board[i][j] == 'Q' || board[i][j] == 'K' || board[i][j] == ' ')
						if ((i + j) % 2 == 0)
							Color(122);
						else
							Color(10);
...
bool move_4(string move, char board[8][8], char color, bool castle[2][3], int k_pos[2][2], deque<string> game, int cond_row = -1, int cond_col = -1)
{
	...
	if (move[1] == 'x' && ((move[0] == 'R' || move[0] == 'N' || move[0] == 'B' || move[0] == 'Q' || move[0] == 'K') || (move[0] >= 'a' && move[0] <= 'h')) && move[2] >= 'a' && move[2] <= 'h' && move[3] >= '1' && move[3] <= '8')
	{
		...
		if (board[x][y] == ((color == 'W') ? 'p' : 'P') || board[x][y] == ((color == 'W') ? 'n' : 'N') || board[x][y] == ((color == 'W') ? 'b' : 'B') || board[x][y] == ((color == 'W') ? 'r' : 'R') || board[x][y] == ((color == 'W') ? 'q' : 'Q'))
		{
			...
			if (move[0] == 'N')
			{
				if ((x + 2) < 8 && (y + 1) < 8 && (board[x + 2][y + 1] == ((color == 'W') ? 'N' : 'n')) && (cond_row != -1 ? cond_row == x + 2 : true) && (cond_col != -1 ? cond_col == y + 1 : true))
				{
					temp = board[x][y];
					board[x][y] = ' ';
				...
				if ((x + 1) < 8 && (y + 2) < 8 && (board[x + 1][y + 2] == ((color == 'W') ? 'N' : 'n')) && (cond_row != -1 ? cond_row == x + 1 : true) && (cond_col != -1 ? cond_col == y + 2 : true))
				{
					temp = board[x][y];
					board[x][y] = ' ';
	...
	for (i = 0; i < 8; i++)
	{
		for (j = 0; j < 8; j++)
		{
			if (1)
			{
				...
				{
					if (board[i - ((color == 'W') ? 1 : -1)][j] == ' ')
					{
						swap(board[i][j], board[i - ((color == 'W') ? 1 : -1)][j]);
						if (!checked(board, color, k_pos[(color == 'W') ? 0 : 1][0], k_pos[(color == 'W') ? 0 : 1][1]))
						{
							swap(board[i][j], board[i - ((color == 'W') ? 1 : -1)][j]);
							return false;
					...
					if (i == 6 && board[i - ((color == 'W') ? 1 : -1)][j] == ' ' && board[i - ((color == 'W') ? 2 : -2)][j] == ' ')
					{
						swap(board[i][j], board[i - ((color == 'W') ? 2 : -2)][j]);
						if (!checked(board, color, k_pos[(color == 'W') ? 0 : 1][0], k_pos[(color == 'W') ? 0 : 1][1]))
						{
							swap(board[i][j], board[i - ((color == 'W') ? 2 : -2)][j]);
							return false;
					...
					if (i != 0 && j != 0 && (board[i - ((color == 'W') ? 1 : -1)][j - ((color == 'W') ? 1 : -1)] == ((color == 'W') ? 'p' : 'P') || board[i - ((color == 'W') ? 1 : -1)][j - ((color == 'W') ? 1 : -1)] == ((color == 'W') ? 'n' : 'N') || board[i - ((color == 'W') ? 1 : -1)][j - ((color == 'W') ? 1 : -1)] == ((color == 'W') ? 'b' : 'B') || board[i - ((color == 'W') ? 1 : -1)][j - ((color == 'W') ? 1 : -1)] == ((color == 'W') ? 'r' : 'R') || board[i - ((color == 'W') ? 1 : -1)][j - ((color == 'W') ? 1 : -1)] == ((color == 'W') ? 'q' : 'Q')))
					{
						char temp = board[i - ((color == 'W') ? 1 : -1)][j - ((color == 'W') ? 1 : -1)];
						board[i - ((color == 'W') ? 1 : -1)][j - ((color == 'W') ? 1 : -1)] = ' ';
						swap(board[i][j], board[i - ((color == 'W') ? 1 : -1)][j - ((color == 'W') ? 1 : -1)]);
						if (!checked(board, color, k_pos[(color == 'W') ? 0 : 1][0], k_pos[(color == 'W') ? 0 : 1][1]))
						{
							swap(board[i][j], board[i - ((color == 'W') ? 1 : -1)][j - ((color == 'W') ? 1 : -1)]);
							board[i - ((color == 'W') ? 1 : -1)][j - ((color == 'W') ? 1 : -1)] = temp;
							return false;
						}
					...
					if (i != 0 && j != 7 && (board[i - ((color == 'W') ? 1 : -1)][j + ((color == 'W') ? 1 : -1)] == ((color == 'W') ? 'p' : 'P') || board[i - ((color == 'W') ? 1 : -1)][j + ((color == 'W') ? 1 : -1)] == ((color == 'W') ? 'n' : 'N') || board[i - ((color == 'W') ? 1 : -1)][j + ((color == 'W') ? 1 : -1)] == ((color == 'W') ? 'b' : 'B') || board[i - ((color == 'W') ? 1 : -1)][j + ((color == 'W') ? 1 : -1)] == ((color == 'W') ? 'r' : 'R') || board[i - ((color == 'W') ? 1 : -1)][j + ((color == 'W') ? 1 : -1)] == ((color == 'W') ? 'q' : 'Q')))
					{
						char temp = board[i - ((color == 'W') ? 1 : -1)][j + ((color == 'W') ? 1 : -1)];
						board[i - ((color == 'W') ? 1 : -1)][j + ((color == 'W') ? 1 : -1)] = ' ';
						swap(board[i][j], board[i - ((color == 'W') ? 1 : -1)][j + ((color == 'W') ? 1 : -1)]);
...
void command_check(string move, deque<string> &game, deque<cryo> &game_board, char board[8][8], bool castle[2][3], int k_pos[2][2])
{
	...
	else if (move == "s" || move == "S")
	{
		string s;
		deque<string> temp = game;
		cout << "Enter the filename you want to save the game in" << endl;
		std::cin >> s;
		ofstream filewriter("saves/" + s + ".txt");
		int i = 0;
		while (!temp.empty())
		{
			filewriter << temp.front();
			if (i % 2 == 0)
				filewriter << " ";
			else
				filewriter << "\n";
	...
	{
		cout << "Input not recognized as a move or a command" << endl;
	}
}

void ChessGame(queue<string> loader)
{
	SetConsoleOutputCP(CP_UTF8);
	mciSendString("open \"chess_music/Move_Piece_1.mp3\" type mpegvideo alias abc", NULL, 0, NULL);
	mciSendString("open \"chess_music/Move_Piece_4.mp3\" type mpegvideo alias xyz", NULL, 0, NULL);
	mciSendString("open \"chess_music/start.mp3\" type mpegvideo alias mp3", NULL, 0, NULL);
	mciSendString("open \"chess_music/Check.wav\" type mpegvideo alias check", NULL, 0, NULL);
	mciSendString("open \"chess_music/Checkmate_Win.wav\" type mpegvideo alias mate", NULL, 0, NULL);
	...
	while (1)
	{
		...
		cout << "Success!" << endl;
		display_board(board);
		mciSendString("play abc from 0", NULL, 0, NULL);
		if (checked(board, 'B', k_pos[1][0], k_pos[1][1]))
		{
			if (check_mate(board, 'B', k_pos))
			{
				cout << "Black's King is Checkmated. White Wins!" << endl;
				mciSendString("play mate from 0", NULL, 0, NULL);
				break;
			}

			cout << "Black is in a check!";
			mciSendString("play check from 0", NULL, 0, NULL);
		}
		else
		{
			if (check_mate(board, 'B', k_pos))
			{
				cout << "Black is in a Stalemate. The Game is a Draw!" << endl;
				break;
			}
		}
		...
		cout << "Success!" << endl;
		display_board(board);
		mciSendString("play xyz from 0", NULL, 0, NULL);
		if (checked(board, 'W', k_pos[0][0], k_pos[0][1]))
		{
		...
		else
		{
			if (check_mate(board, 'W', k_pos))
			{
				cout << "White is in a Stalemate. The Game is a Draw!" << endl;
				break;
			}
		}
		// auto timestop2 = chrono::high_resolution_clock::now();
		// auto duration2 = std::chrono::duration_cast<std::chrono::microseconds>(timestop2 - timestart2);
		// cout<<"Execution Time: "<<duration2.count()<<" microseconds."<<endl;
		cout << endl << endl;
	}

	mciSendString("close mp3", NULL, 0, NULL);
	mciSendString("close abc", NULL, 0, NULL);
	mciSendString("close xyz", NULL, 0, NULL);
	mciSendString("close check", NULL, 0, NULL);
	mciSendString("close checkmate", NULL, 0, NULL);
}
...
int main()
{
	...
	while(1)
	{
		cout<<"Enter 'n' for a new game or 'l' to load a saved game or 'q' to quit"<<endl;
		std::cin>>ans;
		if(ans=='n'||ans=='N')
		{
			ChessGame(loader);
		...
		else if(ans=='l'||ans=='L')
		{
			...
			std::cin>>s;
			ifstream filereader("saves/" + s + ".txt");
			filereader >> s;
			...
			cout<<"I did not understand your input, please provide an input again"<<endl;
	}
	std::cin >> n;
	return 0;
}
